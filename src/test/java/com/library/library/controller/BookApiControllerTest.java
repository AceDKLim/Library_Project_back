...
//         final AddBookRequest bookRequest = new AddBookRequest(isbnNo, title, author, publish, p_year, num, location,
...
//         final String detail_src = "detail_src";
//         final String tags = "tags";
//         bookRepository.save(Book.builder().isbnNo(isbnNo).title(title).author(author).publish(publish).p_year(p_year)
...
//                 .save(Book.builder().isbnNo(isbnNo).title(title).author(author).publish(publish).p_year(p_year)
//                         .num(num).location(location).image_src(image_src).detail_src(detail_src).tags(tags).build());
