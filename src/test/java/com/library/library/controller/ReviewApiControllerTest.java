...
// User user = new User("20123070", "123456", "임동균", "01031709934");
// final String url = "/api/reviews";
// final String title = "title";
// final String content = "content";
// final String isbnNo = "isbnNo";
// // final String studentnumber = principal.getName();
// final String score = "score";
// final AddReviewRequest reviewRequest = new AddReviewRequest(user, title,
// content, isbnNo, score);
...
// .title(title).content(content).isbnNo(isbnNo).studentNumber(studentnumber).score(score)
// .build());
...
// Review savedReview =
// reviewRepository.save(Review.builder().title(title).content(content).isbnNo(isbnNo)
...
// UpdateReviewRequest request = new UpdateReviewRequest(newTitle, newContent,
// newIsbnNo, newStudentNumber,
// newScore);
// // when
